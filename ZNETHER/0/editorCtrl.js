...
function (angular) {
  ...
  module.controller('ZNETHERCtrl', function($scope, $rootScope, $log, wsSrv, deviceSrv) {

    $scope.init = function() {
      $scope.fr = { interval: 5000 };
      $scope.logs = [];
      $scope.refName = 'Reference';
      var i = 0;
      $scope.outputs = [
        {id:'0', name:'o0', value:false},
        {id:'1', name:'o1', value:false},
        {id:'2', name:'o2', value:false},
        {id:'3', name:'o3', value:false},
        {id:'4', name:'o4', value:false},
      ];
